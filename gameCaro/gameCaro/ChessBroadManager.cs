...
namespace gameCaro
{
    public class ChessBroadManager
    {
        ...
        #region Initialize
        public ChessBroadManager(Panel chessBoard) // cons khởi tạo bàn cờ caro với panel của caro
        {
        ...
        public void DrawChessBoard()// phương pháp vẽ bàn cờ caro
        {
            ...
            for (int i = 0; i < Cons.CHESS_BOARD_WIDTH; i++)// lặp qua từng hàng chieu rong của bàn cơ caro
            {
                for (int j = 0; j < Cons.CHESS_BOARD_HEIGHT; j++)// lặp qua từng hàng chieu cao của bàn cơ caro
                {
