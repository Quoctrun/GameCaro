...
namespace GameCaro
{
    public class Cons
    {
        ...
        public static int CHESS_BOARD_HEIGHT = 26;// số lượng  của ô cờ button chieu dọc của bàn cơ caro
        ...
        public static int COOL_DOWN_INTERVAL = 100;// số lượng  của ô cờ button chieu dọc của bàn cơ caro
    }
}
